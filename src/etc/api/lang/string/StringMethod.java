...
public class StringMethod {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(input.isBlank()); // java 11버전 이상부터 사용 가능


        String text = "Hello, SprintLog!";
        System.out.println(text.contains("Sprint"));   // true
        System.out.println(text.startsWith("Hello"));  // true
        System.out.println(text.endsWith("!"));        // true
        System.out.println(text.indexOf("Sprint"));    // 7
        System.out.println(text.indexOf("World"));     // -1 (없으면 -1)

        System.out.println("================================================");

        String joined = String.join("-", "2026", "05", "16");   // "2026-05-16"
        String repeated = "ab".repeat(3);                       // "ababab" — Java 11+
        String formatted = String.format("%.2f", 3.141592);     // "3.14"
        String row = String.format("%s 님은 %d 살입니다.", "박코치", 32);
